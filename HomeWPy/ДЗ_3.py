...
if n >0:
    list1=[random.randint(0,20)for i in range(n+1)]
    print(list1)
else:
    print("Веедите положительное число ")
x=int(input("Введите число x: "))
count=0
for i in list1:
    if x ==i:
        count +=1
print(f"Заданное число повторяется {count} раз")   """
...
for i in list1:
    ...
    if x<list1[0]:
        elem=list1[0]
print(f"Ближайщее число к {x} в списке является {elem}") """
...
slovo=input("Введите одно слово: ").upper()

diction={"A": 1, "B": 3, "C": 3, "D": 2, "E": 1, "F": 4, "G": 2, "H": 4, "I": 1,"J": 8, "K": 5, "L": 1, "M": 3,
...
print(f" Стоимость введенного слова составляет: {count} балов")
